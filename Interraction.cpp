...
//                cin >> raceSelection;
//
//                tempvrace = player.getvrace(raceSelection);
//                tempsp = player.getvspecialpower(raceSelection);
//                victorycoin = 5;
//                for (int i = 1; i < raceSelection; i++) {
//                    race_coin[i] += 1;
//                    victorycoin--;
...
//
//
//                victorycoin += race_coin[raceSelection];
...
//
//                player.pickup(i, victorycoin, numberOfPopulation, player.getvspecialpower(raceSelection),
//                              player.getvrace(raceSelection), false);//function calling
//                player.shift(raceSelection);
//                ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                first_time_edge = true;
//                tempvplayerid = player.vplayer[i].getidPlayer();//temp playid
...
//                    observer.update(observer.getPlayerList(), playercounter, nbplayer, tempvrace, tempsp, numberOfPopulation,
//                                    tempvplayerid, player, turn, " loosing coins", " ", lostRegions,player.vplayer);
//                    br();
...
//                                                    tempsp, numberOfPopulation, tempvplayerid, player, turn, " coins remain same",
//                                                    " conquers region", lostRegions, player.vplayer);
//
...
//
//                                        observer.update(observer.getPlayerList(), playercounter, nbplayer, tempvrace,
//                                                        tempsp, numberOfPopulation, tempvplayerid, player, turn,
//                                                        " coins remain same", " conquers region", lostRegions , player.vplayer);
//
//                                        if (input_temp_enter_pop > tempvplayerpop) {
//                                            cout << "player population cannot be negative" << endl;
//                                        } else {
...
//                                        observer.update(observer.getPlayerList(), playercounter, nbplayer, tempvrace,
//                                                        tempsp, numberOfPopulation, tempvplayerid, player, turn,
//                                                        " coins remain same", " ", lostRegions , player.vplayer);
//                                        //claudia
//                                        cout << "The region cost " << temp_population << " population. \n"
//                                                "How many population you want to occupy??" << endl;
//                                        cin >> input_temp_enter_pop;
...
//                //veiwer.get_player_infomation(tempvplayerid, player);
//                observer.update(observer.getPlayerList(), playercounter, nbplayer, tempvrace, tempsp, numberOfPopulation,
//                                tempvplayerid, player, turn, " collecting coins", " ", lostRegions, player.vplayer);
//                //claudia
...
//                                (player.getvrace(raceSelection),
//                                 player.getvspecialpower(raceSelection));
//
//                        /*cout << "This race you picking us " << player.getvrace(race_select) << " "
//                             << player.getvspecialpower(race_select) << endl;*/
//                        // backup
//
...
//                                                         player.getvspecialpower(raceSelection));
//                        numberOfPopulation = player.getRace_population();
//                        player.vplayer[tempvplayerid - 1].setrace(player.getvrace(raceSelection));
//                        player.vplayer[tempvplayerid - 1].setspecialpower(player.getvspecialpower(raceSelection));
//                        player.vplayer[tempvplayerid - 1].setvictoryCoins(victorycoin);
//                        player.vplayer[tempvplayerid - 1].setpopulation(numberOfPopulation);
